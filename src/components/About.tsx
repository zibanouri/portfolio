    ...
    return (
        ...
        >
            ...
            >
                ...
                <div className="grid md:grid-cols-2 gap-12 items-center text-slate-700 hover:text-slate-600 dark:text-slate-400 dark:hover:text-slate-200">
                    <div
                        className={`bg-${theme}-200/60 backdrop-blur-sm rounded-2xl p-8 border border-${theme}-500/60 hover:border-${theme}-700/60 dark:hover:border-${theme}-300 transition-all duration-300`}
                    >
                    ...
                    <div
                        className={`bg-${theme}-200/60 backdrop-blur-sm rounded-2xl p-8 border border-${theme}-500/60 hover:border-${theme}-700/60 transition-all duration-300 dark:hover:border-${theme}-300`}
                    >
                        <div className="flex items-center mb-6 space-x-3">
                            <Code
                                className={`w-6 h-7  text-${theme}-700 hover:text-${theme}-600 font-black dark:text-${theme}-400 dark:hover:text-${theme}-200`}
                        ...
                        >
                            {iDo.map((item) => (
                                <div
                                    className={`flex items-center hover:text-${theme}-700 dark:text-${theme}-600 dark:hover:text-${theme}-200 transition-colors duration-200`}
                                >
                                    <div
                                        className={`w-3 h-3 rounded-full mr-3 bg-${theme}-700 dark:bg-${theme}-600 dark:hover:bg-${theme}-200 transition-colors duration-200`}
                                    ></div>
                                    {item}
                                    <span
                        ...
                        <div className="mt-8">
                            <a href="/portfolio/Resume.pdf" download>
                                <div className="inline-flex items-center text-slate-800 hover:text-slate-400  dark:text-slate-300 dark:hover:text-slate-100">
